  ...
  "tortas": {
    ...
    "items": [
      ...
      },
      {
        ...
        "d": "Con crema y chips de chocolate — fotografiada en el local",
        "img": "torta.jpg"
      }
    ]
  },
  "bocadillos": {
    "label": "Bocadillos y mesa dulce",
    "items": [
      {
        "n": "Bandeja de bocadillos dulces",
        "d": "Merengues, alfajores y bocados de crema — fotografiada por ellos",
        "img": "bocadillos.jpg"
      },
      {
        "n": "Bandeja de bocadillos salados",
        "d": "Empanaditas y bocados de horno — fotografiada por ellos",
        "img": "bandejas.jpg"
      },
      {
        "n": "Tartaletas de durazno",
        "d": "Con crema, fotografiadas junto a una de sus tortas"
      },
      {
        "n": "Mesa dulce para eventos",
        "d": "Sus propias fotos muestran mesas completas ya montadas"
      }
    ]
  }
};
...
/* ---------- INDICADOR ABIERTO / CERRADO ----------
   SIN HORARIO. Google no publica ninguno porque la ficha del negocio no está reclamada. No se inventa: la página no muestra estado abierto/cerrado. */
